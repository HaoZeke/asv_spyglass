...
- **Environment inventory**: Dump lock-like env pins from a result file; SBOM-style `env-diff`.
- **DataFrame Export**: Export benchmark results to Polars DataFrames / CSV for further analysis.
